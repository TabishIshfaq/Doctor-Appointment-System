...
const SidePanel = ({ doctorId, ticketPrice, timeSlots }) => {
  const minAmount = 150; // Minimum amount in PKR (equivalent to 50 cents)

  const bookingHandler = async () => {
    if (ticketPrice < minAmount) {
      toast.error('The ticket price is too low. The minimum amount must be at least 150 PKR.');
      return;
    }
