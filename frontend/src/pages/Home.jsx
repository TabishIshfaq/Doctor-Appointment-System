...
import { BsArrowRight, BsChatDots, BsFillChatDotsFill, BsFillBarChartFill } from 'react-icons/bs';
...
const Home = () => {
  ...
  const handleChatbotClick = () => {
    window.location.href = 'https://sugarcare-healthcare-chatbot.streamlit.app/';
  };

  const handleModelClick = () => {
    window.location.href = 'http://localhost:8501/'; // Replace with your GitHub model URL
  };

  const handleDietRecommendationClick = () => {
    window.location.href = 'https://diet-recommendation-system.streamlit.app/Custom_Food_Recommendation'; // Replace with your diet recommendation system URL
  };

  return (
    <>
      {/* Existing code for the Home component */}
      ...
      {showModal && (
        <div className="modal">
          <div className="modal-content">
            ...
            <div className="modal-option" onClick={handleChatbotClick}>
              <BsFillChatDotsFill size={20} color="#007bff" />
              <span>Chatbot</span>
            </div>
            <div className="modal-option" onClick={handleModelClick}>
              <BsFillBarChartFill size={20} color="#28a745" />
              <span>Model</span>
            </div>
            <div className="modal-option" onClick={handleDietRecommendationClick}>
              <BsFillBarChartFill size={20} color="#ff5722" />
